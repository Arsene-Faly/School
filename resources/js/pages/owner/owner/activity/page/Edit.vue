...
const form = useForm({
    school_id: props.activity.school_id,
    title: props.activity.title,
    description: props.activity.description,
    cover_photo: null,
});

const previewCover = ref(props.activity.cover_photo || null);
...
function submit() {
    form._method = 'PUT';
    form.post(route('owner.activity.update', { slug: props.activity.slug }), {
        onSuccess: () => {
            Swal.fire({
                icon: 'success',
                title: 'Succès',
            ...
            <div class="bg-gray-50 shadow-lg w-full mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-12 sm:py-16">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="mt-2 text-base sm:text-lg text-gray-600">
                        Modifiez les informations de l'activitée.
                    </p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6 sm:space-y-8">
                    ...
                    <div>
                        ...
                        <Input id="title" v-model="form.title" type="text" required autocomplete="title"
