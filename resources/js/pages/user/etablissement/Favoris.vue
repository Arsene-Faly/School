...
// Crée une copie réactive pour pouvoir modifier la liste côté Vue
...
<UserLayout>
    ...
    <div class="p-6">
        ...
        <div v-if="favoritesList.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="school in favoritesList" :key="school.id"
