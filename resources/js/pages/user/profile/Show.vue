...
<template>
    <UserLayout>
        ...
        <Section name="Profil Utilisateur">
            <AuthProfile>
                <div
                    class="max-w-7xl mx-auto rounded-xl p-12 flex flex-col md:flex-row items-center md:items-start gap-12">
                    <!-- Photo + badge -->
                    <div
                    ...
                    <div class="flex-1 space-y-6">
                        <h1 class="text-4xl font-extrabold text-indigo-800 tracking-tight leading-tight drop-shadow-sm">
                            {{ user1.name }}
                        </h1>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 text-base font-medium">
                            <div class="flex items-center space-x-3 hover:text-indigo-600 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-500 flex-shrink-0"
                            ...
                            <div class="flex items-center space-x-3 hover:text-indigo-600 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-500 flex-shrink-0"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h2l1 7h12l1-7h2" />
                            ...
                            <div class="flex items-center space-x-3 hover:text-indigo-600 transition">
                                ...
                                <span>{{ user.birthdate ? new Date(user.birthdate).toLocaleDateString() : 'Date denaissance non renseignée' }}</span>
                            </div>
